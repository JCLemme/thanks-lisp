...
[Play with thanks on the web](https://lmao.center/thanks)
...
I have no plans. Eventually I'll hack in integer support, so I can port my [pongo macro assembler](https://github.com/jclemme/pongo-vm) to the Web. Otherwise I'll keep adding library functions until I get bored, then I'll **throw it all away** and write a new version (with a JIT compiler).
